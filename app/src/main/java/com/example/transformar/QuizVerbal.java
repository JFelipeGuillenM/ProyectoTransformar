...
public class QuizVerbal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_verbal);
        ...
        mRootReference.child("usuarios").child(userID).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(QuizVerbal.this, "No se encontró el usuario", Toast.LENGTH_SHORT).show();
            }
        });
        setPreguntas();
    }
    ...
    public void iniciarContador(){
        ...
        countDownTimer = new CountDownTimer(120000, 1200) {
            ...
            public void onFinish() {
                if(vidaInicial>=2){
                    Toast.makeText(QuizVerbal.this, "Has perdido una vida", Toast.LENGTH_SHORT).show();
                }
                vidaInicial--;
                setVida();
                iniciarContador();
    ...
    public void setVida(){
        ...
        if(vida == 3){
            ...
            finish();
            Intent i = new Intent(this, ResultadoVerbal.class);
    ...
    public void setPreguntas(){
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.child("verbal").getChildren()){
                ...
                sgtePregunta.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(totalPreguntas == 1){
                            countDownTimer.cancel();
                            finish();
                            Intent i = new Intent(v.getContext(), ResultadoVerbal.class);
                            i.putExtra("puntaje", puntajeValue);
                            startActivity(i);
                            //guardarRecord(puntajeValue, obtenerNombre());
                        }
    ...
    public void guardarRecord(int puntaje, String nombre){
        ...
        DocumentReference documentReference = mFirestore.collection("recordsVerbal").document();
